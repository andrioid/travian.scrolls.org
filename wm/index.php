			...
			foreach ($TA as $i=>$tline) {
				if (isset($tline['sources'])) {
					foreach ($tline['sources'] as $j=>$sline) {
						...
						printf("<tr id=\"$rowclass\"><td id=\"nametd\">%s</td><td id=\"allytd\">%s</td><td id=\"xytd\">%s</td><td id=\"comment\">%s</td><td id=\"nametd\">%s</td><td id=\"allytd\">%s</td><td id=\"xytd\">%s</td><td id=\"comment\">%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", 
